	...
	<br>
		<div class="card c1">
			<div class="card-body c1">
				...
				<c:choose>
				<c:when test="${form.id==0}"><b><s:message code="label.addcourse" /></b></c:when>
				<c:otherwise><b><s:message code="label.updatecourse"></s:message></b></c:otherwise>
				</c:choose>
				</h3>
