	...
	<div class="col-md-6">
		<div class="card c1">
			<div class="card-body c1">
				...
				<c:choose>
				<c:when test="${form.id==0}"><b><s:message code="label.addfaculty" /></b></c:when>
				<c:otherwise><b><s:message code="label.updatefaculty"></b></s:message></c:otherwise>
				</c:choose>
				</h3>
			...
			<font color="red"><sf:errors path="subjectId" /></font> <br>
			...
			<font color="red"><sf:errors path="courseId" /></font> <br>
			...
			<font color="red"><sf:errors path="collegeId" /></font> <br>
			...
			<font color="red"><sf:errors path="mobileNo" /></font> <br>
			...
			<font color="red"><sf:errors path="login" /></font> <br>
