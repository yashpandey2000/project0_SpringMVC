	...
	<div class="col-md-6">
		<div class="card c1">
			<div class="card-body c1">
				...
				<c:choose>
				<c:when test="${form.id==0}"><b><s:message code="label.adduser" /></b></c:when>
				<c:otherwise><b><s:message code="label.updateuser"></b></s:message></c:otherwise>
				</c:choose>
				</h3>
				...
				<sf:label path="gender">
					...
					<div class="input-group-prepend">
						<span class="input-group-text"> <span
							class="fas fa-user-circle  grey-text"></span>
						</span>
					</div>
			...
			<font color="red"><sf:errors path="password" /></font> <br>
