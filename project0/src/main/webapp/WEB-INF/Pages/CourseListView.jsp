...
<div class="row">
	<div class="col-lg-12">
		<div class="card card-table c1">
			...
			<u>	<b><s:message code="label.courselist"></s:message></b></u>
			</h3>
			<div class="row">
				...
				<c:if test="${!empty list}">
					<div class="row p-2 d-flex justify-content-center">
						<div class="col-lg-3">
							...
							<div class="col-lg-3">
							<sf:select path="duration" class="form-control border-left-right">
								<sf:option value="0">
									<s:message code="label.selectduration" />
								</sf:option>
								...
								<tr>
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Course/AddCourse?id=" />
              							<a class="btn btn-outline-warning btn-block btn-round w-100" href="${editUrl}${course.id}"><i class="fa fa-edit" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>
								</tr>
							</c:forEach>
