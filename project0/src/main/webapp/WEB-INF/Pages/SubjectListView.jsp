	...
	<div class="col-lg-12">
		<div class="card card-table c1">
			<h3 class="w-100 text-center under-over-line">
				<b><u><s:message code="label.subjectlist"></s:message></u></b>
			</h3>
			<div class="row">
			...
			<sf:form method="post" modelAttribute="form">
				...
				<c:if test="${!empty list}">
					<div class="row p-2 d-flex justify-content-center">
						...
						<div class="col-lg-3">
						<sf:input path="subjectName" cssClass="form-control border-left-right"
									...
									<c:forEach items="${list}" var="subject" varStatus="ct">
										<tr>
											...
											<td class="text-center"><c:url var="editUrl"
													value="/ctl/Subject/AddSubject?id=" /> <a
												class="btn btn-outline-warning btn-block btn-round w-100"
												href="${editUrl}${subject.id}"><i class="fa fa-edit"
