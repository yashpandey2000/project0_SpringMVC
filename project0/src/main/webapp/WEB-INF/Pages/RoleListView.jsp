...
<div class="row">
	<div class="col-lg-12">
		<div class="card card-table c1">
			...
			<u><b><s:message code="label.rolelist"></s:message></b></u>	
			</h3>
			<div class="row">
							...
							<table
								...
								<thead class="c3">
									<tr>
										...
										<th scope="col" class="text-center" style="width: 10%;"><s:message
												code="label.edit" /></th>
									</tr>
								</thead>
								<tbody>
								...
								<tr>
									<td class="text-center">
										<input class="checkbox" name="chk_1" type="checkbox" value="${role.id}">
									</td>
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Role/AddRole?id=" />
              							<a class="btn btn-outline-warning btn-block btn-round w-100" href="${editUrl}${role.id}"><i class="fa fa-edit" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>
								</tr>
							</c:forEach>
